...
public class Report {
	...
	public static void sendreport (String resultFile,String startTime)  {
	...
	public static String makeReport(List<Map<String,String>> resultlist) {
		...
		//替换图片和发件人
		content=content.replace("http://47.105.110.138/imgs/logo_big.png", "http://www.testingedu.com.cn/images/logo_2.png");
